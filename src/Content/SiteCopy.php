        ...
        'de' => [
            ...
            'booking' => [
                ...
                'slot' => [
                    ...
                    'more' => 'Mehr Zeiten anzeigen',
                    'less' => 'Weniger Zeiten anzeigen',
                ...
                'mail' => [
                    'subject' => 'Ihre Terminbestätigung bei Datenflow',
                    ...
                    'reschedule_subject' => 'Ihr Termin wurde verschoben',
                    'reschedule_body' => "Hallo {name},\n\nIhr Termin bei Datenflow wurde verschoben. Der neue Termin:\n\nWann: {when}\nArt:  {type}\n{extra}\n\nFalls der neue Termin nicht passt, antworten Sie einfach auf diese E-Mail.\n\nViele Grüße\nMohammad Beshtawi, Datenflow",
                    'cancel_subject' => 'Ihr Termin wurde abgesagt',
                    'cancel_body' => "Hallo {name},\n\nleider müssen wir Ihren Termin am {when} absagen, entschuldigen Sie bitte die Umstände.\n\nAntworten Sie einfach auf diese E-Mail oder buchen Sie auf unserer Website einen neuen Termin.\n\nViele Grüße\nMohammad Beshtawi, Datenflow",
                ],
            ],
            'contact' => [
                'kicker' => 'Kontakt',
        ...
        'en' => [
            ...
            'booking' => [
                ...
                'slot' => [
                    ...
                    'more' => 'Show more times',
                    'less' => 'Show fewer times',
                ...
                'mail' => [
                    'subject' => 'Your booking confirmation at Datenflow',
                    ...
                    'reschedule_body' => "Hello {name},\n\nYour call with Datenflow has been moved. The new time:\n\nWhen: {when}\nHow:  {type}\n{extra}\n\nIf the new time does not work for you, just reply to this email.\n\nBest regards\nMohammad Beshtawi, Datenflow",
                    'cancel_subject' => 'Your appointment was cancelled',
                    'cancel_body' => "Hello {name},\n\nunfortunately we have to cancel your appointment on {when}, our apologies for the inconvenience.\n\nJust reply to this email, or book a new slot on our website.\n\nBest regards\nMohammad Beshtawi, Datenflow",
                ],
            ],
            'contact' => [
                'kicker' => 'Contact',
