  ...
  de: {
    ...
    contact: {
      ...
      f: {
        ...
        topic: "Thema",
        topicOpts: ["Prozess‑Automatisierung", "Chat / KI‑Agent", "Sicherheits‑Audit", "Custom Software", "Etwas anderes"],
        message: "Worum geht es?",
        messagePh: "Beschreiben Sie kurz den Engpass.",
        summaryLabel: "Ihre Angaben aus dem Vorgespräch",
        ...
        errors: {
          ...
          send_failed: "Versand fehlgeschlagen. Bitte versuchen Sie es später erneut.",
          server_misconfigured: "Versand fehlgeschlagen. Bitte versuchen Sie es später erneut.",
          network: "Verbindung fehlgeschlagen. Bitte prüfen Sie Ihr Netzwerk.",
        },
      },
    },
    footer: {
    ...
    bookingFlow: {
      ...
      steps: [
        {
          q: "Was möchten Sie in Ihrem Unternehmen verbessern?",
          opts: ["Produktivität steigern", "Prozesse automatisieren", "Daten besser organisieren", "Fehler reduzieren", "Kundenservice verbessern"],
        },
        {
          q: "Interessieren Sie sich für einen KI-gestützten Chatbot?",
          opts: ["Ja, für Kundenservice", "Ja, für interne Teams", "Vielleicht später", "Nein"],
        },
        {
          q: "Welche Bereiche kosten aktuell am meisten Zeit?",
          opts: ["Manuelle Dateneingabe", "Dokumentenverwaltung", "Kundenanfragen", "Interne Kommunikation", "Reporting & Analyse"],
        },
        {
          q: "Was ist Ihr Hauptziel in den nächsten 12 Monaten?",
          opts: ["Mehr Umsatz", "Höhere Effizienz", "Weniger manuelle Arbeit", "Schnellere Prozesse", "Wettbewerbsvorteil durch KI"],
        },
      ],
    },
    karriere: {
  ...
  en: {
    ...
    contact: {
      ...
      f: {
        ...
        topic: "Topic",
        topicOpts: ["Process automation", "Chat / AI agent", "Security audit", "Custom software", "Something else"],
        message: "What's it about?",
        messagePh: "Briefly describe the bottleneck.",
        summaryLabel: "Your answers from the pre-screening",
        ...
        errors: {
          ...
          server_misconfigured: "Sending failed. Please try again later.",
    ...
    bookingFlow: {
      ...
      steps: [
        {
          q: "What would you like to improve in your company?",
          opts: ["Increase productivity", "Automate processes", "Better organise data", "Reduce errors", "Improve customer service"],
        },
        {
          q: "Are you interested in an AI-powered chatbot?",
          opts: ["Yes, for customer service", "Yes, for internal teams", "Maybe later", "No"],
        },
        {
          q: "Which areas currently cost the most time?",
          opts: ["Manual data entry", "Document management", "Customer inquiries", "Internal communication", "Reporting & analytics"],
        },
        {
          q: "What is your main goal in the next 12 months?",
          opts: ["More revenue", "Higher efficiency", "Less manual work", "Faster processes", "Competitive advantage through AI"],
        },
      ],
    },
    karriere: {
